...
const UploadFlashSale = () => {
    ...
    const handleSubmit = (e)=>{
        ...
        axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/event/flash-sale`, formData)
    .then(res => {
      console.log(res);
    ...
    return (
        <div>
          ...
          <p className="text-2xl font-bold mb-5">Upload FlashSale Image</p>
          <Box
            component="form"
            sx={{
...
export default UploadFlashSale;