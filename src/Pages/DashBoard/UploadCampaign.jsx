...
const UploadCampaign = () => {
    ...
    const handleSubmit = (e)=>{
        ...
        axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/event/campaign`, formData)
    .then(res => {
      console.log(res);
    ...
    return (
        <div>
          ...
          <p className="text-2xl font-bold mb-5">Create Campaign</p>
          <Box
            component="form"
            sx={{
          ...
          >
            <div className=''>
                <label htmlFor="Date">Enter Date (YYYY-MM-DDTHH:mm:ss):</label>
        <TextField
          label="Date"
          type="text"
          variant="standard"
