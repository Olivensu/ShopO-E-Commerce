...
// console.log(userinfo);
    ...
    const orderedItem = orderItem?.filter((item, index) => item.status==='Shipped')
      

    const handleSubmit=(id)=>{

        axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/order/status`,{_id:id, status: 'PickupPoint'})
        .then(res=>{
            axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/order/`)
            .then(res=>{
                console.log(res.data.payload);
...
export default ShippedOrderTable;