...
const Trending = () => {
  ...
  useEffect(() => {
    ...
    const eventProduct = products?.filter(product => product.isTrending ===true)
    ...
    return (
        <div className='shadow-lg shadow-red my-10'>
            ...
            <p className='flex justify-start items-center text-xl'><img src={tranding} alt="" /> <p className='ml-5'> Trending Now</p></p>
                <Link to='/products/isTrending'><button className='inline-block btn btn-secondary text-white'>Show More</button></Link>
              </div>
