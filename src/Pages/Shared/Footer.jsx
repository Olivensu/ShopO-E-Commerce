...
Dhanmondi, Dhaka-1209.</p> 
  ...
  <div>
    ...
    <Link to='/profile' className="link link-hover">Your Account</Link> 
    <Link to='/orders' className="link link-hover">Your Order</Link> 
    <Link to='/terms-conditions' className="link link-hover">Terms & Conditions</Link> 
    <Link to='/return-refund' className="link link-hover">Return & Refund Policy</Link>
  </div> 
  <div>
